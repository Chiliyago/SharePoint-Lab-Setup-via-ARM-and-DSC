...
$MachineName = "SP-WEB1" # this is the machine being configured

## DSC ps1 File to execute
$dscFileName = 'C:\_DSC\SharePoint_DSC_PowerShell_Setup_Scripts\DSC\SP-Web1\SP-Web1-DSC.ps1'
