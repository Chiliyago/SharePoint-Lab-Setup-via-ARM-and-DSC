...
$MachineName = "SP-SQL1" # this is the machine being configured

## DSC ps1 File to execute
$dscFileName = 'C:\_DSC\SharePoint_DSC_PowerShell_Setup_Scripts\DSC\SP-SQL1\SP-SQL1-DSC.ps1'
...
$mof = SPSetupSql1DSC -DnsIP $DnsIP -FarmSetupCredential $FarmSetupCredential -SqlServerName $SqlServerName -SqlInstanceName $SqlInstanceName -DomainAdminCredential $DomainAdminCredential -SqlSvcAcctCredential $SqlSvcAcctCredential -DomainName2Join $DomainName -MachineName $MachineName -ConfigurationData $configData -OutputPath $outPath -Verbose
$mof
