...
$MachineName = "SP-APP1" # this is the machine being configured

## DSC ps1 File to execute
$dscFileName = 'C:\_DSC\SharePoint_DSC_PowerShell_Setup_Scripts\DSC\SP-App1\SP-App1-DSC.ps1'
